...
function DistanceConstraint(a, b, stiffness, distance /*optional*/) {
    this.a = a;  // particle
    this.b = b;  // particle
    this.distance = typeof distance != 'undefined' ?
...
DistanceConstraint.prototype.relax = function(stepCoef) {
    ...
    normal.mutableScale(((this.distance * this.distance - m) / m) *
...
DistanceConstraint.prototype.setCornerPoints = function() {
    ...
    var rmCos = (this.b.pos.x - this.a.pos.x) /
        Math.sqrt(Math.pow(this.a.pos.x - this.b.pos.x, 2) +
            Math.pow(this.a.pos.y - this.b.pos.y, 2));    // cos
    var rmSin = (this.b.pos.y - this.a.pos.y) /
        Math.sqrt(Math.pow(this.a.pos.x - this.b.pos.x, 2) +
            Math.pow(this.a.pos.y - this.b.pos.y, 2));    // sin
